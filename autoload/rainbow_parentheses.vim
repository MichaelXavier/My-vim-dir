...
function rainbow_parentheses#Activate()
    highlight default level1c   guifg=OrangeRed1      ctermfg=202
    highlight default level2c   guifg=LightGoldenRod1 ctermfg=202
    highlight default level3c   guifg=DeepSkyBlue1    ctermfg=39
    highlight default level4c   guifg=HotPink1        ctermfg=205
    highlight default level5c   guifg=chartreuse1     ctermfg=118
    highlight default level6c   guifg=OrangeRed1      ctermfg=202
    highlight default level7c   guifg=LightGoldenRod1 ctermfg=202
    highlight default level8c   guifg=DeepSkyBlue1    ctermfg=39
    highlight default level9c   guifg=HotPink1        ctermfg=205
    highlight default level10c  guifg=chartreuse1     ctermfg=118
    highlight default level11c  guifg=OrangeRed1      ctermfg=202
    highlight default level12c  guifg=LightGoldenRod1 ctermfg=202
    highlight default level13c  guifg=DeepSkyBlue1    ctermfg=39
    highlight default level14c  guifg=HotPink1        ctermfg=205
    highlight default level15c  guifg=chartreuse1     ctermfg=118
    highlight default level16c  guifg=Yellow          ctermfg=226
    let s:rainbow_parentheses_active = 1
endfunction
...
function rainbow_parentheses#Clear()
    ...
    endwhile
    let s:rainbow_parentheses_active = 0
endfunction

function rainbow_parentheses#Toggle ()
    if ! exists('s:rainbow_parentheses_active')
        call rainbow_parentheses#LoadRound ()
    endif
    if s:rainbow_parentheses_active != 0
